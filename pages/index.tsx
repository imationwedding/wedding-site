  ...
  return (
    <div className="min-h-screen bg-white text-gray-900">
      ...
      >
        ...
        >
          Megörökítjük életed legszebb pillanatait, hogy újra és újra átélhesd
          őket.
        </motion.p>
      ...
      <section
        id="about"
        className="py-20 px-6 md:px-20 text-center max-w-4xl mx-auto"
      >
        <h2 className="text-4xl font-bold mb-6">Rólunk</h2>
        <p className="text-lg text-gray-600">
          Több éves tapasztalattal készítünk gyönyörű, érzelmekkel teli
          esküvői filmeket. Nemcsak rögzítjük a pillanatokat, hanem történetet
          mesélünk, amely örökre megmarad.
        </p>
      </section>
